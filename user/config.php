...
define( 'YOURLS_DB_PASS', 'qyXSFsgnBNtRmSkwTrMlWGlUIqrgJArm' );
...
define( 'YOURLS_SITE', 'https://url.linksite.my.id' );
...
define( 'YOURLS_COOKIEKEY', '$2y$10$TbyyJlV6jC.JwzWTXoYNfOJAfWMAdvlwlw/ZMjSo6VwOjVauVMBa6' );
...
*/
$yourls_reserved_URL = [
	'porn', 'faggot', 'sex', 'nigger', 'fuck', 'cunt', 'dick','scum','dirt','slot','judi'
];
